...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Access/index');?>" class="a1">权限管理</a>>><a class="a1" href="<?php echo U('Access/rolelist');?>">角色列表</a>>添加/编辑角色</div>
      <div class="center_t">
        
        <form action="" method="post">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="center_t tab">
            <tr>
              <td width="120">角色组名称：</td>
            ...
            <tr>
                <td colspan="2"><input type="submit" name="sub" class="btn submit" id="sub" value="提交" /></td>
            </tr>
          </table>
