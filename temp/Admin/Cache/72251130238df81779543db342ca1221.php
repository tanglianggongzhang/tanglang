...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Access/index');?>" class="a1">权限管理</a>>><a class="a1" href="<?php echo U('Access/nodelist');?>">节点列表</a>>添加/编辑 节点</div>
      <div class="center_t">
        <form action="" method="post">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="center_t tab">
            <tr>
              <td width="120">名称：</td>
              <td><input name="name" type="text" class="input" size="40" value="<?php echo ($info["name"]); ?>" />
                英文
                ，为MODEL_NAME的时候首字母大写</td>
            </tr>
            <tr>
              <td>显示名：</td>
              <td><input class="input" name="title" type="text" size="40" value="<?php echo ($info["title"]); ?>" />
                中
                英文均可</td>
            </tr>
            <tr>
              ...
              <td><select name="status" style="width: 80px;">
                  <?php if($info["status"] == 1): ?><option value="1" selected>启用</option>
                    ...
                    <option 
value="0" selected>禁用</option><?php endif; ?>
                </select>
            ...
            <tr>
              ...
              <td><label><input type="radio" name="is_menu" id="is_menu" value="1" 
                  <?php if($info["is_menu"] == 1): ?>checked<?php endif; ?>
                  />是</label>
                <label><input type="radio" name="is_menu" id="is_menu" value="0" 
                  <?php if($info["is_menu"] == 0): ?>checked<?php endif; ?>
                  />否</label></td>
            </tr>
            <tr>
              <td>类型：</td>
              <td><select name="level" style="min-width: 80px;">
                  <?php echo ($info["levelOption"]); ?>
                </select>
                项目
